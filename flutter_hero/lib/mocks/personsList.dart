...
List<Person> personsListMock = [
  Person(
      id: "emily",
      name: "Emily Fortuna",
      bio: "Emily Fortuna",
      photoUrl:
          "http://www.emilyfortuna.com/wp-content/uploads/2013/12/EmilyFortuna-Headshot.jpg"),
  Person(
      id: "iiro",
      name: "Iiro Krankka",
      bio:
  ...
  Person(
      ...
      bio:
          "Co-founder Flutter Study Group on Slack. Writing code for 18+ years. Now at DevAngels, London",
      photoUrl:
